...
def print_profile_report(df: pd.DataFrame, wallet: str, probs: ProfileProbabilities, sleep: SleepWindow, reaction: ReactionSpeedAnalysis):
    ...
    print("\n" + "═" * 70)
    print(" 🔍 LEAKLENS SURVEILLANCE EXPOSURE REPORT")
    print("═" * 70)
...
def print_connection_report(connections: Dict[Tuple[str, str], WalletConnection], wallets: List[str]):
    ...
    print("\n" + "═" * 70)
    print(" 🔍 LEAKLENS CONNECTION ANALYSIS")
    print("═" * 70)
...
def print_banner():
    ...
    ║                                                                   ║
    ║       Surveillance Exposure Analysis for Solana                   ║
...
def main():
    parser = argparse.ArgumentParser(
        description="🔍 LeakLens - Solana Surveillance Exposure Analysis",
...
Examples:
  ...
  python gator_solana.py scan wallet1 --depth 2
    ...
    if args.command == "profile":
        ...
        csv_path = f"leaklens_profile_{args.address[:8]}.csv"
