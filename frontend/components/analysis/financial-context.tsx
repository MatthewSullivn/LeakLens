          ...
          <CardContent className="pt-0 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                ...
                <p className="text-[10px] text-muted-foreground uppercase tracking-wide mt-0.5">Total SOL</p>
              </div>
              <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                <p className={cn(
            ...
            {/* Net worth / portfolio context (SOL price from CoinGecko) */}
            {hasNetWorth && (
              <div className="space-y-2">
                <p className="text-[10px] text-muted-foreground uppercase tracking-wide">Portfolio context</p>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {solPrice > 0 && (
                    <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                      <p className="text-lg font-semibold tabular-nums text-foreground">
                      ...
                      <p className="text-[10px] text-muted-foreground uppercase tracking-wide mt-0.5">SOL price</p>
                    </div>
                  )}
                  {totalUsd > 0 && (
                    <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                      ...
                      <p className="text-[10px] text-muted-foreground uppercase tracking-wide mt-0.5">Est. total (USD)</p>
                    </div>
                  )}
                  {solBalance > 0 && (
                    <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                      ...
                      <p className="text-[10px] text-muted-foreground uppercase tracking-wide mt-0.5">SOL balance</p>
                    </div>
                  )}
                  {tokenCount > 0 && (
                    <div className="p-3 rounded-lg bg-muted/20 border border-border/30">
                      <p className="text-lg font-semibold tabular-nums text-foreground">{tokenCount}</p>
                      <p className="text-[10px] text-muted-foreground uppercase tracking-wide mt-0.5">Tokens</p>
                    </div>
                  )}
                </div>
              </div>
